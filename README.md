...
**报告字段**：涉及API、注册分类（1类创新/2类改良/3-4类仿制）、一致性评价（过评=已上市仿制、有真实产能）、证据来源、产品名称（CDT 中文商品名 / CT.gov 干预名）、剂型（⭐口服固体加粗）、药物分类（仿制药/原研药/新药/新药（改良型）/观察性研究）、企业联系方式（联系人/电话/邮箱/地址）、试验状态、登记号与日期、来源（CDT/CT.gov）、本次是否新增。
